...
/* Unified ADB Keyboard Layout covers ANSI, ISO versions
 * ,---.   ,---------------. ,---------------. ,---------------. ,-----------.             ,---.
 ...
 * |  `|  1|  2|  3|  4|  5|  6|  7|  8|  9|  0|  -|  =|Backspa| |Ins|Hom|PgU| |NmL|  =|  /|  *|
 * |-----------------------------------------------------------| |-----------| |---------------|
 * |Tab  |  Q|  W|  E|  R|  T|  Y|  U|  I|  O|  P|  [|  ]| Retu| |Del|End|PgD| |  7|  8|  9|  -|
 * |-----------------------------------------------------+     | `-----------' |---------------|
 * |CapsLo|  A|  S|  D|  F|  G|  H|  J|  K|  L|  ;|  '|  \|  rn|               |  4|  5|  6|  +|
 * |-----------------------------------------------------------|     ,---.     |---------------|
 * |Shift|  \|  Z|  X|  C|  V|  B|  N|  M|  ,|  .|  /| Shift   |     |Up |     |  1|  2|  3|   |
 * |-----------------------------------------------------------| ,-----------. |-----------|Ent|
 * |Ctrl |Opt |Cmd  |         Space           |    |Opt |Ctrl  | |Lef|Dow|Rig| |      0|  .|   |
 ...
 * +---------------------------------------------------------+ +-------+---|ent|
 * |cap|opt|comnd| ` |       space       | \ |lef|rig|dwn|up | |   0   | . |   |
 * +---------------------------------------------------------+ +-------+---+---+
 */
