...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_TRNS,XXXXXXX,KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,          KC_TRNS,            KC_NO,              TO(0),  TO(2),  TO(4),
    KC_TRNS,KC_TRNS,KC_TRNS,                        KC_NO,                                          KC_TRNS,KC_TRNS,    KC_NO,  KC_NO,  KC_NO,      KC_NO,          KC_NO,  KC_NO
    ),
    ...
    KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,          KC_NO,              KC_NO,              TO(0),  TO(2),  TO(4),
